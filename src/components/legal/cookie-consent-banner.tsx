...
export function CookieConsentBanner() {
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-kumbu-border bg-kumbu-surface/95 p-4 shadow-lg backdrop-blur-md md:bottom-4 md:left-4 md:right-auto md:max-w-md md:rounded-2xl md:border"
      role="dialog"
